    ...
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        <%
        	if (session.getAttribute("userAdmin") == null) {
                            ...
                            ArrayList<Users> listUsers = usersDAO.getListUsersPageList(keyword, (pages-1)*recordsPerPage, recordsPerPage);
                            int noOfRecords = usersDAO.countUsers();       
                ...
                <div class="content-wrapper">
                    ...
                    <section class="content">
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="row">
                                    <form method="get" action="/Asean/ManagerUsersServlet">
                                        <div class="col-md-6">
                                ...
                                <div class="row">     
                                    ...
                                    <table class="table table-bordered ">
                                        ...
                                        <tr>
                                            ...
                                            <td>			                    		
                                                <a class="btn btn-sm btn-primary" href="edit_users.jsp?userID=<%=user.getUserID()%>">
                                                    <i class="fa fa-pencil"></i>
                                               </a>                                                
                                                
                                                <a class="btn  btn-sm btn-danger" href="/Asean/ManagerUsersServlet?command=delete&userid=<%=user.getUserID()%>"><i class="fa fa-trash"></i></a>
