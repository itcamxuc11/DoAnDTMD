    ...
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        <%
        	if (session.getAttribute("userAdmin") == null) {
                            ...
                            ArrayList<News> listProduct = newsDAO.getListProductPageList(keyword, (pages-1)*recordsPerPage, recordsPerPage);
                            int noOfRecords = newsDAO.countProduct();       
                ...
                <div class="content-wrapper">
                    ...
                    <section class="content">
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="row">
                                    <form method="get" action="/Asean/ManagerNewsServlet">
                                        <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <button onclick="window.location.href='insert_news.jsp'" class="btn btn-success">Add News</button>
                                    </div>
                                </div>
                                                 <br>
                                <div class="row">     
                                    ...
                                    <table class="table table-bordered ">
                                        ...
                                        <%
                                        	int count1 = 0;
                                                                                    for (News news : listProduct) {
                                                                                        count1++;
                                        %>
                                        <tr>
                                            <td><%=count1%></td>
                                            <td>                                   
                                                <img src="${pageContext.request.contextPath}/<%=news.getNewsImage()%>" class="img-responsive" alt="<%=news.getNewsImage()%>">
                                            </td>                                   
                                            ...
                                            <td>			                    		
                                                <a class="btn btn-sm btn-primary" href="edit_news.jsp?productID=<%=news.getNewsID()%>">
                                                    <i class="fa fa-pencil"></i>
                                               </a>                                                
                                                <button class="btn  btn-sm btn-danger" onclick="deleteRecord(<%=news.getNewsID()%>);">
                        ...
                        <div class="box-footer">
                            ...
                            <ul class="pagination pagination-sm">
                                ...
                                <%for (int i = 1; i <= noOfPages; i++) {%>
                                    <li><a href="${pageContext.request.contextPath}/admin/manager_news.jsp?&pages=<%=i%>"><%=i%></a></li>
                                <%}%>
                                <li>
        ...
        <script src="${pageContext.request.contextPath}/admin/content/dist/js/demo.js"></script>
          ...
          <script language="javascript">
            function deleteRecord(id){
                var doIt=confirm('Do you want to delete this news?');
                if(doIt){
                    var xhttp;
                    var url = "/Asean/ManagerNewsServlet?command=delete&productidDele="+id;
